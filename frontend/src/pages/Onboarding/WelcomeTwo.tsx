...
export default function WelcomeTwo({navigation}){
    ...
    function handkeNext(){
        navigation.navigate('/welcome-three')
    }
        ...
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                <WelcomeFirts 
                    ...
                    children={'Apprentissage'}
                    children1={'ludique'}
                    children2={'Teste tes compétences avec des mini-quiz'}
                    children3={'ludiques adaptés à ton niveau scolaire.'}
                />
                ...
                <ButtonComponent onPress={handkeNext} style={styles.nextContain}>
                    <TextComponent style={styles.next}>Suivant</TextComponent>
